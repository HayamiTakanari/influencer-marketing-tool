...
export const acceptApplication = async (req: Request, res: Response) => {
  try {
    ...
    if (application.companyId !== client.id) {
    ...
    try {
      ...
      await NotificationService.createApplicationAcceptedNotification(
        ...
        updatedApplication.project.company.companyName,
...
export const getProjectById = async (req: Request, res: Response) => {
  try {
    ...
    if (userRole === 'CLIENT') {
      ...
      if (!client || project.companyId !== client.id) {
...
export const updateProject = async (req: Request, res: Response) => {
  try {
    ...
    if (existingProject.companyId !== client.id) {
...
export const copyProject = async (req: Request, res: Response) => {
  try {
    ...
    if (!client || originalProject.companyId !== client.id) {
