...
exports.getRegistrationStatus = exports.resendVerificationEmail = exports.verifyEmail = exports.registerWithEmailVerification = void 0;
 ...
 * メール認証トークン付きで登録を完了
 */
const registerWithEmailVerification = async (req, res) => {
    try {
        ...
        // メール認証トークンを送信
        try {
            await (0, email_verification_service_1.sendEmailVerification)(result.id, result.email);
        }
        catch (error) {
...
exports.registerWithEmailVerification = registerWithEmailVerification;
/**
...
const resendVerificationEmail = async (req, res) => {
    try {
        ...
        await (0, email_verification_service_1.resendEmailVerification)(user.id);
        res.json({
...
const getRegistrationStatus = async (req, res) => {
    try {
        ...
        const documentsApproved = Array.isArray(documentsInfo) &&
            documentsInfo.every((doc) => doc.status === 'APPROVED');
...
//# sourceMappingURL=auth-chapter1.controller.js.map