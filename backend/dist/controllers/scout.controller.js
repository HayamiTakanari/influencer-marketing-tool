...
exports.getScoutDetails = exports.getMySentScouts = exports.getMyScoutInvitations = exports.rejectScout = exports.acceptScout = exports.sendScoutInvitation = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
// Chapter 3: Send scout invitation
const sendScoutInvitation = async (req, res) => {
    try {
...
exports.sendScoutInvitation = sendScoutInvitation;
// Chapter 3: Accept scout invitation
const acceptScout = async (req, res) => {
    try {
        const userId = req.user?.id;
...
exports.acceptScout = acceptScout;
// Chapter 3: Reject scout invitation
const rejectScout = async (req, res) => {
    try {
        const userId = req.user?.id;
        const { scoutId } = req.params;
...
exports.rejectScout = rejectScout;
// Chapter 3: Get scout invitations
const getMyScoutInvitations = async (req, res) => {
    try {
        const userId = req.user?.id;
...
exports.getMyScoutInvitations = getMyScoutInvitations;
// Chapter 3: Get sent scouts (for client)
const getMySentScouts = async (req, res) => {
    try {
        const userId = req.user?.id;
        const status = req.query.status;
        // Get client ID
...
exports.getMySentScouts = getMySentScouts;
...
const getScoutDetails = async (req, res) => {
    try {
        ...
        // Verify access
        const hasAccess = scoutRecord.influencer.userId === userId || scoutRecord.client.userId === userId;
        if (!hasAccess) {
            return res.status(403).json({ error: '権限がありません' });
        }
...
exports.getScoutDetails = getScoutDetails;
