...
exports.getMyContracts = exports.rejectContract = exports.signContract = exports.getContract = exports.createContract = void 0;
...
const signContract = async (req, res) => {
    try {
        ...
        const canSign = contract.project.client.userId === userId ||
        ...
        const otherUserId = contract.project.client.userId === userId
...
const rejectContract = async (req, res) => {
    try {
        ...
        const canReject = contract.project.client.userId === userId ||
            contract.project.matchedInfluencer?.userId === userId;
        if (!canReject) {
            return res.status(403).json({ error: '権限がありません' });
        }
