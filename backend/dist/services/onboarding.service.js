...
exports.getOnboardingCompletionRate = exports.getOnboardingSteps = exports.getOnboardingProgress = exports.skipOnboarding = exports.completeOnboardingStep = exports.initializeOnboarding = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
/**
 * Chapter 1-12: オンボーディング進捗管理
 */
const initializeOnboarding = async (userId, role) => {
    try {
 ...
 * ステップを完了
 */
const completeOnboardingStep = async (userId, step) => {
    try {
 ...
 * オンボーディング完了率を取得
 */
const getOnboardingCompletionRate = async () => {
    try {
...
exports.getOnboardingCompletionRate = getOnboardingCompletionRate;
