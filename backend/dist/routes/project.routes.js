...
router.post('/:projectId/apply', sns_verification_1.verifySNSConnections, project_controller_1.applyToProject);
...
router.get('/company', project_controller_1.getCompanyProjects);
// Get matched projects for influencer (for project chats)
router.get('/matched', project_controller_1.getMatchedProjects);
// Get project by ID
...
router.post('/:projectId/copy', project_controller_1.copyProject);
// Unpublish project (for clients) - Chapter 2-8
router.put('/:projectId/unpublish', project_controller_1.unpublishProject);
// End project (for clients) - Chapter 2-8
router.put('/:projectId/end', project_controller_1.endProject);
